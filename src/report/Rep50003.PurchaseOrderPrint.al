report 50003 "Purchase Order - Print"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(UserSignatures; UserSignature.Signature)
            {
            }
            column(SentApprovalDate; SentApprovalDate)
            {
            }
            ...
            column(Working_Description; "Working Description")
            {
            }
            ...
            begin
                ...
                if ApprovalEntries.FindLast() then begin
                    ...
                    ApprovedDate := ApprovalEntries."Last Date-Time Modified";
                    SentApprovalDate := ApprovalEntries."Date-Time Sent for Approval";

                    UserSignature.Reset();
                    UserSignature.SetRange(UserSignature."User Id", ApproverID);
                    if UserSignature.FindFirst() then
                        UserSignature.CalcFields(Signature);
                end;
            end;
        }
    }
    ...
    var
        ...
        ApproverID: Code[100];
        UserSignature: Record "User Signature";
        SentApprovalDate: DateTime;
