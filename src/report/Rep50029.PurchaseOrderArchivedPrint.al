report 50029 "PurchaseOrderArchived Print"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Purchase Header Archive"; "Purchase Header Archive")
        {
            ...
            column(Purchase_Header_Archive_User_Id; "Purchase Header Archive"."USER ID")
            {
            }
            column(Purchase_Header_Archive_Approver_Id; "Purchase Header Archive"."Approver Id")
            {
            }
            column(Purchase_Header_Archive_Approver_Name; "Purchase Header Archive"."Approver Name")
            {
            }
            column(Purchase_Header_Archive_Status; "Purchase Header Archive".Status)
            {
            }
            column(Purchase_Header_Archive_Archived_By; "Purchase Header Archive"."Archived By")
            {
            }
