report 50016 "Purchase - Requisition"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        //=IIF(Fields!Description_PurchaseLine.Value="" OR Fields!Type_PurchaseLine.Value="0",TRUE,FALSE)
        dataitem("Purchase Header"; "Purchase Header")
        {
            DataItemTableView = SORTING("Document Type", "No.") WHERE("Document Type" = CONST(Quote));
            RequestFilterFields = "No.", "Buy-from Vendor No.", "No. Printed";
            RequestFilterHeading = 'Purchase - Requisition';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(QuoteAmount; "Purchase Line"."Amount Including VAT")
                        {
                        }
