report 50017 "Bank Acc. - Detail Petty Cash"
{
    DefaultLayout = RDLC;
    RDLCLayout = './BankAccDetailTrialBal.rdlc';
    ApplicationArea = Basic, Suite;
    Caption = 'Bank Accounts - Detail Petty Cash';
    ...
    dataset
    {
        dataitem("Bank Account"; "Bank Account")
        {
            ...
            dataitem("Bank Account Ledger Entry"; "Bank Account Ledger Entry")
            {
                ...
                Column(Authorisedby_BankAccountLedgerEntry; "Bank Account Ledger Entry"."Authorised by")
                {
                }
                Column(PaidToReceivedFrom_BankAccountLedgerEntry; "Bank Account Ledger Entry"."Paid To/Received From")
                {
                }
                Column(Requestedby_BankAccountLedgerEntry; "Bank Account Ledger Entry"."Requested by")
                {
                }
                Column(Reviewedby_BankAccountLedgerEntry; "Bank Account Ledger Entry"."Reviewed by")
                {
                }
                Column(Approvedby_BankAccountLedgerEntry; "Bank Account Ledger Entry"."Approved by")
                {
                }
                Column(GLName_BankAccountLedgerEntry; "Bank Account Ledger Entry"."GL Name")
                {
                }
                Column(Preparedby_BankAccountLedgerEntry; "Bank Account Ledger Entry"."Prepared by")
                {
                }
