page 50052 "Sales Order Subform POS Coded"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
            ...
            repeater(Control1)
            {
                ...
                field("Cross-Reference No."; "Cross-Reference No.")
                {
                    ...
                    begin
                        ...
                        DeltaUpdateTotals;
                        // V1.0.0
                        IF ("Cross-Reference No." <> '') AND (Type = Type::Item) THEN BEGIN
                            VALIDATE(Quantity, 1);
                            VALIDATE(Coded, TRUE);
                ...
                field("No."; "No.")
                {
                    ...
                    begin
                        ...
                        if Type = Type::Item then begin
                            // Code the Item and Cross Reference it
                            VALIDATE(Coded, TRUE);
                            ItemCrossReference.RESET;
                            ItemCrossReference.SETCURRENTKEY("Item No.", "Variant Code", "Unit of Measure", "Cross-Reference Type", "Cross-Reference No.", "Discontinue Bar Code");
                            ItemCrossReference.SETRANGE("Cross-Reference Type", ItemCrossReference."Cross-Reference Type"::"Bar Code");
                            ItemCrossReference.SETRANGE(ItemCrossReference."Item No.", "No.");
                            ItemCrossReference.SETRANGE(ItemCrossReference."Unit of Measure", Item."Sales Unit of Measure");
                        ...
                        // V1.0.0 POS
                        "User ID" := SalesHeader."User ID";
                        Drawer := SalesHeader.Drawer;
                        // V1.0.0 POS

                        // V1.0.0 Price Including VAT
                        //IF Item."Consider Item Unit Price" THEN
                        //"Unit Price" := Item."Unit Price";
                        //VALIDATE("Unit Price");
                        // V1.0.0 capture the sales time
                        VALIDATE("Sale Time", TIME);
                    end;
                }
    ...
    var
        ...
        UserPassword: Text[40];
        ASLT0001: Label 'The Unit Price Cannot be less than the Default Unit Price';
        ASLT0002: Label 'You Are not Allowed To Change The Sales Price';
        ASLT0003: Label 'Password You Provided is Not Valid';
