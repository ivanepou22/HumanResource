page 50047 "Purchase Requisitions Self"
{
    Caption = 'Purchase Requisitions SelfService';
    PageType = List;
    UsageCategory = Lists;
    ...
    Editable = false;
    SourceTableView = WHERE("Document Type" = CONST(Quote), "Requisition Type" = CONST(Service));
