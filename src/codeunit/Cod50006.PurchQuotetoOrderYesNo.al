codeunit 50006 "PurchQuote to Order (Yes/No)"
{
    ...
    begin
        ...
        if not ConfirmManagement.GetResponseOrDefault(ConvertQuoteToOrderQst, false) then
            exit;
    ...
    var
        ...
        PurchQuoteToOrder: Codeunit "PurchQuote to Order";
