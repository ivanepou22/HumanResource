codeunit 50009 "PurchQuote to Order"
{
    ...
    begin
        ...
        with PurchHeader do begin
            ...
            // V1.0.0 Attaching vendor from requisition
            IF ("Purchase Vendor No." <> '') THEN BEGIN
                PurchOrderHeader.SetHideValidationDialog(TRUE);
                PurchOrderHeader.VALIDATE("Buy-from Vendor No.", "Purchase Vendor No.");
            END;
            // V1.0.0 Attaching vendor from requisiton
    ...
    begin
        ...
        if PurchQuoteLine.FindSet then
            repeat
                ...
                if not IsHandled then begin
                    ...
                    // ASL V1.0.0 Requisition; Copying Status from Quote to Order lines
                    PurchOrderLine.Status := PurchOrderLine.Status::Open;
                    // ASL V1.0.0 Requisition; Copying Status from Quote to Order lines
        ...
        PurchOrderHeader.Validate("Shortcut Dimension 1 Code", PurchQuoteHeader."Shortcut Dimension 1 Code");
        PurchOrderHeader.Validate("Shortcut Dimension 2 Code", PurchQuoteHeader."Shortcut Dimension 2 Code");
    end;
