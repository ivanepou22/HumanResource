codeunit 50006 "ResJnlPost Line"
{
    ...
    procedure InsertPayrollPeriod(DateofPosting: Date; StatisticsGroup: Code[10]; VAR ResourceLedgerEntry: Record "Res. Ledger Entry")
    var
        EntryNumber: Integer;
    begin
    ...
    procedure ModifyPayrollPeriod(VAR ResourceLedgerEntry: Record "Res. Ledger Entry")
    var
        myInt: Integer;
    begin
        ResourceLedgerEntry."Period Closed" := TRUE;
