table 50012 "Payroll Journal Lines"
{
    ...
    procedure OnAfterCopyFromResJnlLine(var ResLedgerEntry: Record "Payroll Journal Lines"; ResJournalLine: Record "Res. Journal Line")
    begin
    end;
}
